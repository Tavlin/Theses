Im Standardmodell der Elementarteilchenphysik werden die  Elementarteilchen in zwei Gruppen, die  Quarks und die  Leptonen, unterteilt.
...
Tabelle \ref{tab:teilchen} listet die Elementarteilchen auf, geordnet nach ihrer  Generation und ihrer elektrischen Ladung.
%maybe weglassen?
...
\end{tabular}
\caption{Austauschteilchen geordnet nach ihrer entsprechenden Wechselwirkung.}
...
Trägt ein Teilchen eine Ladung, so koppelt es an eine  Wechselwirkung, die beschreibt, wie Teilchen sich gegenseitig beeinflussen können.
...
\newline
Wechselwirkungen zwischen zwei Teilchen werden durch den Austausch von  Austauschteilchen vermittelt.
